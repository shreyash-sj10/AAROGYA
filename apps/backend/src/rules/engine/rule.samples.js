const rules = [
...

  {
      ...
      conditions: [
        {
          ...
          conditions: [
            {
              entity: "user.risk_flags",
              operator: "includes",
              value: "high_gi_sensitive",
            },
            {
              entity: "user.conditions",
              operator: "includes",
    ...
    action: {
      type: "reject",
      message_template:
        "High glycemic foods are not suitable for this metabolic profile.",
    },
  },
  {
  ...
  },
  {
    ...
    action: {
      type: "reject",
      message_template:
        "Strong pitta aggravating foods are not suitable for high pitta states.",
    },
  },
  {
    ...
    logic_tree: {
      ...
      conditions: [
        { entity: "user.prakriti.kapha", operator: ">", value: 0.6 },
        {
          ...
          conditions: [
            {
              entity: "food.functional.heaviness_score",
              operator: ">",
              value: 0.6,
            },
            {
              entity: "food.ayurveda.guna",
              operator: "includes",
              value: "heavy",
            },
            {
    ...
    action: {
      type: "reject",
      message_template:
        "Heavy or oily foods are not suitable for high kapha states.",
    },
  },
  {
    ...
    action: {
      type: "reject",
      message_template:
        "Very heavy foods are not suitable when digestion is weak.",
    },
  },
  {
  ...
  },
  {
      ...
      conditions: [
        { entity: "user.agni_strength", operator: "<", value: 0.4 },
        {
          ...
          conditions: [
            ...
            {
              entity: "food.functional.digestibility_score",
              operator: "<",
              value: 0.4,
            },
          ],
    ...
    action: {
      ...
      penalty: 0.4,
      message_template:
        "Heavy or poorly digestible foods may not suit low agni states.",
    },
  },
  {
  ...
  },
  {
    ...
    action: {
      ...
      penalty: 0.15,
      message_template:
        "Cold foods may be less suitable in winter when digestion is weak.",
    },
  },
  {
    ...
    action: {
      ...
      penalty: 0.2,
      message_template:
        "Less digestible foods are not preferred during monsoon.",
    },
  },
  {
    ...
    action: {
      ...
      penalty: 0.25,
      message_template:
        "Pungent and sour rasa foods may aggravate high pitta states.",
    },
  },
  {
    ...
    action: {
      ...
      penalty: 0.25,
      message_template:
        "Sweet and sour rasa foods may aggravate high kapha states.",
    },
  },
  {
    ...
    action: {
      ...
      penalty: 0.3,
      message_template:
        "Oily and heavy guna foods may aggravate high kapha states.",
    },
  },
  {
