...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/plan", element: <Navigate to="/system/builder" replace /> },
      { path: "/builder", element: <Navigate to="/system/builder" replace /> },
      { path: "/result", element: <Navigate to="/system/result" replace /> },
